...
fn expected_status(method: HttpMethod, path: &str) -> StatusCode {
    match (method, path) {
        ...
        (HttpMethod::Post, "/api/projects/{slug}/runs/validate-config") => StatusCode::NOT_FOUND,
        ...
        (HttpMethod::Get, "/api/projects/{slug}/style-guides") => StatusCode::NOT_FOUND,
        (HttpMethod::Post, "/api/projects/{slug}/style-guides") => StatusCode::BAD_REQUEST,

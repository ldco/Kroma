...
- When you have a technical brief in `.qwen-data/project-brief.md`
...
```
Read .qwen-data/project-brief.md     # Technical brief from wizard
Read app/puppet-master.config.ts       # Project configuration
Read .qwen-data/context.md           # Session context (if exists)
```
...
If `.qwen-data/project-brief.md` doesn't exist:

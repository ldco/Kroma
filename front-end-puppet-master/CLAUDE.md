...
**Note**: Claude Code is one of multiple available AI workflows in Puppet Master. See `docs/architecture/ai-workflows.md` for information about workflow selection.
